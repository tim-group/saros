...
import de.fu_berlin.inf.dpp.intellij.editor.mock.ui.IElementStateListener;
...
public class DirtyStateListener implements IElementStateListener
{
    ...
    protected final EditorManagerEcl editorManager;

    public DirtyStateListener(EditorManagerEcl editorManager)
    {
    ...
    public void elementDirtyStateChanged(Object element, boolean isDirty)
    {
        ...
        SWTUtils.runSafeSWTSync(log, new Runnable()
        {
            ...
            public void run()
            {
                ...
                EditorManagerEcl.log.debug("Dirty state reset for: "
                        + file.toString());
