...
import de.fu_berlin.inf.dpp.intellij.editor.intl.SelectionProvider;
import de.fu_berlin.inf.dpp.intellij.editor.intl.StyledText;
import de.fu_berlin.inf.dpp.intellij.editor.intl.events.IViewportListener;
...
public interface ITextViewer
{
    ...
    void setTopIndex(int topPosition);
