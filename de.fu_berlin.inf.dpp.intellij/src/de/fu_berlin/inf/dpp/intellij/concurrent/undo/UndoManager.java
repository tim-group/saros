...
import de.fu_berlin.inf.dpp.intellij.mock.editor.operations.*;
import de.fu_berlin.inf.dpp.intellij.mock.editor.operations.events.IOperationHistoryListener;
import de.fu_berlin.inf.dpp.intellij.mock.editor.operations.events.OperationHistoryEvent;
import de.fu_berlin.inf.dpp.intellij.mock.editor.text.IDocument;
...
public class UndoManager extends AbstractActivityProvider implements Disposable {
    ...
    protected Operation calcUndoOperation(SPath editor) {
        ...
        for (OperationHistory.EditorHistoryEntry entry : undoHistory
