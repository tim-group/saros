...
//                DialogUtils.openWindow(wizardDialog);
            ...
            OutgoingSessionNegotiation negotiation)
    {
        ...
        System.out.println("NegotiationHandler.handleOutgoingSessionNegotiation");
...
//        outgoingInvitationJob.schedule();
            ...
            OutgoingProjectNegotiation negotiation)
    {
        ...
        System.out.println("NegotiationHandler.handleOutgoingProjectNegotiation");
        //todo
...
//                                | SWT.PRIMARY_MODAL);
        ...
        // Map<String,String> prjNames = new HashMap<String, String>();
        // process.accept(process.getProjectNames(),new NullProgressMonitor(),false); //todo
 ...
 * {@link de.fu_berlin.inf.dpp.invitation.OutgoingSessionNegotiation} and cares about handling the
        ...
        SWTUtils.runSafeSWTAsync(LOG, new Runnable() {
            ...
            public void run() {
                ...
                *//*
                 ...
                 *
                 * When we now open this wizard with setBlockOnOpen(true) this
                 * wizard will become the core dispatcher for the SWT Thread. As
                 * this wizard is non modal you cannot close it because you
                 * could not access it. Therefore the modal dialog cannot be
                 * closed as well because it is stuck on the non modal dialog
                 * which currently serves as core dispatcher !
                 *//*
