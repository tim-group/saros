...
public class IncomingSessionNegotiation extends SessionNegotiation
{
    ...
    private IJoinSession inInvitationUI;
    ...
    public synchronized boolean remoteCancel(String errorMsg)
    {
        ...
        {
            inInvitationUI.cancelWizard(peer, errorMsg, ProcessTools.CancelLocation.REMOTE);
        }
            ...
            ProcessTools.CancelOption cancelOption)
    {
        ...
        if (inInvitationUI != null)
        {
            inInvitationUI.cancelWizard(peer, errorMsg, ProcessTools.CancelLocation.LOCAL);
        }
    ...
    public synchronized void setInvitationUI(IJoinSession inInvitationUI)
    {
