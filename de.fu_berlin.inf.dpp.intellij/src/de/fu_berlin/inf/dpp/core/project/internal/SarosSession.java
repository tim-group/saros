...
public final class SarosSession implements ISarosSession
{
    ...
    public void initiatePermissionChange(final User user,
            final User.Permission newPermission) throws CancellationException,
    ...
    @Override
    public void setPermission(final User user, final User.Permission permission)
    {
    ...
    */
    ...
    public void addProjectOwnership(String projectID, IProject project,
            JID ownerJID)
    {
        System.out.println("SarosSession.addProjectOwnership>>" + projectID + " P=" + project);
