...
/**
 * Created by IntelliJ IDEA. User: r.kvietkauskas Date: 14.3.14 Time: 11.15 To
 * change this template use File | Settings | File Templates.
 *
 * TODO Consider new platform-independent XMPPAccountStore from Gerrit #1422 (http://saros-build.imp.fu-berlin.de/gerrit/1422)
 */
public class XMPPAccount implements Serializable
{
    ...
    public XMPPAccount(String username, String password, String domain,
